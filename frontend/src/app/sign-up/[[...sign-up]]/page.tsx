...
export default function SignUpPage() {
  return (
    <div className="min-h-screen flex flex-col lg:flex-row-reverse bg-[#050505]">
      {/* Back button */}
      <Link href="/" className="absolute top-6 right-6 text-gray-400 hover:text-white flex items-center gap-2 transition-colors z-50">
        Back to home <ArrowLeft className="w-5 h-5 rotate-180" />
      </Link>

      {/* Right side (now visually left on reversed): AI Graphic / Marketing */}
      <div className="hidden lg:flex flex-1 relative bg-[#111] border-l border-[#27272a] items-center justify-center overflow-hidden">
        {/* Background effects */}
        ...
        <div className="relative z-10 flex flex-col items-center justify-center p-12 text-center max-w-lg">
          ...
          <p className="text-xl text-gray-400 leading-relaxed">
            Join thousands of producers and DJs extracting studio-quality stems in seconds.
          </p>
        </div>
      </div>

      {/* Left side (now visually right): Clerk Component */}
